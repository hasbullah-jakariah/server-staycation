...
describe("API ENDPOINT TETSTING", () => {
    it("GET Landing Page", (done) => {
        chai.request(app).get("/api/v1/member/landing-page").end((err, res) => {
            ...
            expect(res.body.hero).to.have.all.keys('treasures', 'travelers', 'cities')
    ...
    it('POST Booking Page', (done) => {
        ...
        chai.request(app).post('/api/v1/member/booking-page')
          ...
          .field('bookingDateStart', dataSample.bookingStartDate)
          .field('bookingDateEnd', dataSample.bookingEndDate)
          ...
          .end((err, res) => {
            ...
            expect(res.body.booking).to.have.all.keys('payments', '_id', 'invoice', 'bookingDateStart', 'bookingDateEnd', 'total', 'itemId', 'memberId', '__v');
